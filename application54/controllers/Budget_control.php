...
class Budget_control extends MY_Controller {
    ...
    public function index()
    {
        ...
        $list = $this->Requisition_details_model->get_all_department_budget();
    ...
    public function approve($id){
        ...
        $this->email->set_newline("\r\n");
          ...
          $req_list = $this->Approval_model->get_by_recommend($id);
            ...
            $recipientArr = array($host->audit_mail, $host->procure_mail, $host->admin_mail, $host->budget_mail, $b_department->email, $b_department->general_email, $host->dfs_mail);
            
             $data3 = array(
                        'info'=>'Purchased Order for supply of requisition items with refence number: '.$dept->reference.' by department of '.$get_department->dept_name.' approved by Budget Control.',
            ...
            'sap_receive'=>$date,
              ...
              $dept=$this->Requisition_details_model->get_by_id($id);
             $get_department = $this->Department_model->get_email($dept->department_id);
            $recipientArr = array($host->audit_mail, $host->procure_mail, $host->admin_mail, $host->budget_mail);
            
             $data3 = array(
                        'info'=>'Purchased Order for supply of requisition items with reference number: '.$dept->reference.' by department of '.$get_department->dept_name.' approved by Budget Control.',
    ...
    public function reject($id)
        ...
        $this->email->set_newline("\r\n");
            ...
            'supply_status'=>2,
                  ...
                  $data3 = array(
                        'info'=>'Purchase Order for supply of requisition items with reference number: '.$dept->reference.' by department of '.$get_department->dept_name.'rejected by Budget Control',
                    );
                    $option = array(
            ...
            $recipientArr = array($host->audit_mail, $host->procure_mail, $host->admin_mail, $host->budget_mail, $b_department->email, $b_department->general_email, $get_department->general_email, $get_department->email);
