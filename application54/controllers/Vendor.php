...
class Vendor extends MY_Controller {
	 ...
	 function __construct() {
        ...
        $cate = $this->Vendor_category_model->get_all();
         ...
         if ($this->form_validation->run() == FALSE) {
            ...
            $time=$this->input->post('timepicker',TRUE);
              ...
              $phone = "234".substr($supplier->primary_phone,1);
                        $msg = "Dear ".$supplier->company_name.", Congrats. you have been scheduled for interview on ".$date.", ".$time.". Login go to your dashboard on http://procure.lfcww.org to view.";
                    $this->sms($msg, $phone);
