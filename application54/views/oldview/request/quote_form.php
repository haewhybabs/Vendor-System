        ...
        ?>
                ...
                <?php
                    ...
                    ?>
                     ...
                     <form data-style="arrow" role="form" enctype="multipart/form-data" method="post" action="<?= site_url('request/create_action') ?>">
                       <div id="planContainer">
                          ...
                          <br>
                           <div class="col-sm-12">
                                <input type="submit" class="btn btn-success" value="Send Quote Request">
                           </div>
                      </form>
                </div>
              </div>
