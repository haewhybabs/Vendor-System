     <link href="<?= base_url(); ?>assets/global/plugins/summernote/summernote.min.css" rel="stylesheet">    
            ...
            <div class="col-xlg-12 col-small-stats">
              <div class="row">
                ...
                <div class="panel-header bg-dark">
                  <h6 class="panel-title" style="font-size: 17px;">HOD REQUISITION QUERY</h6>
                   </div>
        ...
        ?>
                ...
                <?php
                    ...
                    <form data-style="arrow" role="form" enctype="multipart/form-data" method="post" action="<?= site_url('requisition/query_action') ?>">
                            ...
                            <div class="form-group">
                              <label>Query Destination <span class="text-danger">*</span></label>
                                ...
                                <select class="form-control" name="destination" id="category" required>  
                                         ...
                                         <option value="2">Head Technical Department</option> 
                                         <option value="3">Store Department</option>         
                                </select>
                                </div>
                            </div>
