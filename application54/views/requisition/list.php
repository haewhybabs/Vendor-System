            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header">
                 ...
                 <h3><i class="fa fa-table"></i> <strong>REQUISITION LISTS OF <?= $v->dept_name; ?></strong></h3>
               <?php endif;?>
                        ...
                        <tr>
                            ...
                            <td><?=$vendor->entry_date;?></td>
                             <td><?=$vendor->category;?></td>
                              <td>
                                  <a href="<?=base_url();?>Requisition/Activity_history/<?=$vendor->req_ID;?>" class="btn btn-primary">Activity History</a>
                              </td>
