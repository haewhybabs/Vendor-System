                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?= $vendor->category; ?></td>
                           ...
                           <td>
                            <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-basic<?= $vendor->id; ?>"><span class="fa fa-eye"></span> View Rejected Requisitions</a>
                            <a href="<?= site_url('requisition/approve/'.$vendor->id); ?>"  target="_blank" class="btn btn-success btn-sm" ><span class="fa fa-check"></span>Re-approve </a>
                           </td>
