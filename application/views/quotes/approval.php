                        ...
                        <tr>
                          ...
                          <td>
                           ...
                           <td>
                            ...
                            <?php elseif($vendor->negotiated=='1'):?>
                               <a href="<?= site_url('quotes/approvalsheet_negotiate/'.$vendor->rfq_ID); ?>" class="btn btn-primary btn-sm" ><span class="fa fa-eye"></span> Create Approval 1Sheet</a>
                            <?php else:?>
