     ...
     <link href="<?= base_url(); ?>assets/global/plugins/datatables/dataTables.min.css" rel="stylesheet">
        ...
        ?>
          ...
          <?php else:?>
               ...
               <?php echo form_open('Quotes/sheet_neg_approve');?>
                                      ...
                                      <tr>
                                        ...
                                        <td><?=$q->product_name;?></td>
                                         <td><?=$q->product_specification;?></td>
                                          <td><?=$q->quantity?></td>
                                           <td>
                                            <?php foreach ($negotiate as $neg) {
                                              if($q->req_detail_ID==$neg->req_detail_ID && $q->vendor_ID==$neg->vendor_ID):?>
                                                
                                                  <?php $number= $neg->negotiated_price;?>
