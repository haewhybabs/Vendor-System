...
<head>
        <meta charset="utf-8">
        <title>Living Faith Admin Login</title>
    ...
    <body class="account2" data-page="login">
        ...
        <div class="container" id="login-block">
            ...
            <div class="account-form">
                <form class="form-signin" role="form" action="<?= site_url('home/user_login') ?>" method="post"> 
                <!-- <form class="form-signin" role="form" action="<?= site_url('home/login') ?>" method="post"> -->
                   <?php
                    ...
                    <div class="append-icon">
                        <input type="text" name="username" id="name" class="form-control form-white username" placeholder="Username">
