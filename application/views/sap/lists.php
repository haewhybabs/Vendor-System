                                ...
                                <div class="modal-dialog">
                                  ...
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      ...
                                      <h4 class="modal-title">SAP/FORENSIC Approve</h4>
                                    </div>
                                    <div class="modal-body">
                                      <form action="<?=base_url('Sap/approve');?>" method="POST">
                              ...
                              <div id="myModal<?=$y;?>" class="modal fade" role="dialog">
                                <div class="modal-dialog">
                                  ...
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <button type="button" class="close" data-dismiss="modal">&times;</button>
                                      <h4 class="modal-title">SAP Dis-Approve</h4>
                                    </div>
                                    <div class="modal-body">
                                      <form action="<?=base_url('Sap/reject');?>" method="POST">
                                        <input type="hidden" name="req_id" value="<?=$vendor->req_ID;?>">
                                          <input type="hidden" name="rfq_id" value="<?=$vendor->rfq_ID;?>">
                                        <div class="form-group">
                                          <label for="comment">Comment</label>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="width: 10px;">
                            ...
                            <td> <?php if($vendor->approval_sheet_status =='0'){ echo 'Not Recommended'; }else{echo 'Recommended';}?>
                            </td>
                             <td><?=$vendor->budget_reference;?></td>
                           <td>
