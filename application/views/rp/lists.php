                  ...
                  <div class="filter-left">
                    <table class="table table-dynamic table-tools table-bordered table-striped" data-table-name="Total users">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td style="width: 15px;"><?= $vendor->dept_name; ?></td>
                           <td>PO/LF/000<?= $vendor->rfq_ID; ?></td>
                          <td style="width: 15px;"><?= $vendor->category; ?></td>
                          <td style="width: 15px;"><?=$vendor->deadline;?></td>
                          <td style="width: 10px;">
                            <?php $x=0;?>
                          ...
                          <td style="width: 10px;">
                            ...
                            <a href="<?= site_url('quotes/submit_view_count/'.$vendor->rfq_ID); ?>" class="btn btn-primary btn-sm" ><span class="fa fa-eye"></span><?=$x;?></a></td>
                             <td style="width: 15px;"><?=$vendor->budget_reference;?></td>
                           <td>
                                ...
                                <div class="modal-dialog">
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                      <form action="<?=base_url('Rp/approve');?>" method="POST">
                              ...
                              <div id="myModal<?=$y;?>" class="modal fade" role="dialog">
                                <div class="modal-dialog">
                                  ...
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <button type="button" class="close" data-dismiss="modal">&times;</button>
                                      <h4 class="modal-title">Dis-Approve Requisition</h4>
                                    </div>
                                    <div class="modal-body">
                                      <form action="<?=base_url('Rp/reject');?>" method="POST">
                                        <input type="hidden" name="req_id" value="<?=$vendor->req_ID;?>">
                                          <input type="hidden" name="rfq_id" value="<?=$vendor->rfq_ID;?>">
                                        <div class="form-group">
                                          <label for="comment">Comment</label>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="width: 10px;">
                            ...
                            <a href="<?= site_url('quotes/submit_view_count/'.$vendor->rfq_ID); ?>" class="btn btn-default btn-sm" ><span class="fa fa-eye"></span><?=$x;?></a></td></td>
                            <td> <?php if($vendor->approval_sheet_status =='-1'){ echo 'Not Recommended'; }else{echo 'Recommended';}?>
                            </td>
                             <td style="width: 15px;"><?=$vendor->budget_reference;?></td>
                           <td>
                            
                                <a href="<?= site_url('quotes/sheet_procure/'.$vendor->rfq_ID); ?>" class="btn btn-primary btn-sm" ><span class="fa fa-eye"></span>View</a>
                                 <a href="<?= site_url('Requisition/Activity_history/'.$vendor->req_ID); ?>" class="btn btn-primary btn-sm" ><span class="fa fa-eye"></span>History</a>
                                <?php if($vendor->approval_sheet_status=='7'):?>

                               <?php elseif($vendor->approval_sheet_status=='-1'):?>
