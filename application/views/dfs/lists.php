                        ...
                        <tr>
                          ...
                          <td style="width: 10px;">
                           ...
                           <td>
                                ...
                                <a href="<?= site_url('quotes/sheet_procure/'.$vendor->rfq_ID); ?>" class="btn btn-info btn-sm" ><span class="fa fa-eye"></span>View</a>
                                ...
                                <div class="modal-dialog">
                                  ...
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      ...
                                      <h4 class="modal-title">Procure Committee Recommend</h4>
                                    </div>
                                    <div class="modal-body">
                                      <form action="<?=base_url('Dfs/approve');?>" method="POST">
                              ...
                              <div id="myModal<?=$y;?>" class="modal fade" role="dialog">
                                <div class="modal-dialog">
                                  ...
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <button type="button" class="close" data-dismiss="modal">&times;</button>
                                      <h4 class="modal-title">Procure Committee</h4>
                                    </div>
                                    <div class="modal-body">
                                      <form action="<?=base_url('Dfs/reject');?>" method="POST">
                                        <input type="hidden" name="req_id" value="<?=$vendor->req_ID;?>">
                                          <input type="hidden" name="rfq_id" value="<?=$vendor->rfq_ID;?>">
                                        <div class="form-group">
                                          <label for="comment">Comment</label>
                    ...
                    <table class="table table-dynamic table-tools table-bordered table-striped" data-table-name="Total users">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="width: 15px;"><?= $vendor->category; ?></td>
                          <td style="width: 10px;"><?=$vendor->deadline;?></td>
                          <td style="width: 10px;">
                            <?php $x=0;?>
                            <?php foreach ($get_count as $count) {
                              if ($count->rfq_ID==$vendor->rfq_ID){
                          ...
                          <td style="width: 10px;">
                            ...
                            <td> <?php if($vendor->approval_sheet_status =='1'){ echo 'DisApproved'; }else{echo 'Recommended';}?>
                            </td>
                           ...
                           <td>
                                ...
                                <a href="<?= site_url('quotes/sheet_procure/'.$vendor->rfq_ID); ?>" class="btn btn-default btn-sm" ><span class="fa fa-eye"></span>View</a>
                                 <a href="<?= site_url('Requisition/Activity_history/'.$vendor->req_ID); ?>" class="btn btn-primary btn-sm" ><span class="fa fa-eye"></span>History</a>
                                <?php if($vendor->approval_sheet_status=='5'):?>

                               <?php elseif($vendor->approval_sheet_status=='1' && $vendor->procure_forensic_status=='1'):?>
