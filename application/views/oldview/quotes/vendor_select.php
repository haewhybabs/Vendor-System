     <link href="<?= base_url(); ?>assets/global/plugins/summernote/summernote.min.css" rel="stylesheet">    
            ...
            <div class="col-xlg-12 col-small-stats">
              <div class="row">
                ...
                <div class="panel-header bg-dark">
                  <h6 class="panel-title" style="font-size: 17px;">SET PRICE FOR SELECTED VENDORS</h6>
                   </div>
        ...
        ?>
               ...
               <?php /*foreach($cat_list as $index => $docs){
                    ...
                    <form data-style="arrow" role="form" enctype="multipart/form-data" method="post" action="<?= site_url('quotes/select_action') ?>">
                           ...
                           <input type="hidden" name="prod_id[]" value="<?= $list->id; ?>">
                             <div class="col-lg-4">
                              <div class="form-group">
                               ...
                               <div class="col-lg-6">
                            <div class="form-group">
                              <label>Select vendor for PO<span class="text-danger">*</span></label>
...
?>
                             ...
                             <div class="col-lg-2">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control form-white" placeholder="Price" name="price[]" value="<?php echo set_value('price'); ?>">
                              </div>
                              </div> 
                           </div>
                        <?php }?>
                          ...
                          <br>
                           <div class="col-sm-12">
                                <input type="submit" class="btn btn-success" value="SET PRICES FOR PURCHASE ORDER">
                           </div>
                      </form>
                </div>
              </div>
