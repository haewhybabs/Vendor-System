            ...
            <div class="col-xlg-12 col-small-stats">
              <div class="row">
                ...
                <div class="panel-header bg-dark">
                  <h6 class="panel-title" style="font-size: 17px;">REQUEST FOR PROPOSAL</h6>
                   </div>
        ...
        ?>
                ...
                <?php
                    ...
                    ?>
                     ...
                     <form data-style="arrow" role="form" enctype="multipart/form-data" method="post" action="<?= site_url('request/proposal_create_action') ?>">
                       <div id="planContainer">
                              ...
                              <div class="input-group">
                                <div class="icheck-list">
                                  <?php foreach($vendor_list as $cat){?>
                                    <label>
                                     <input type="checkbox" data-checkbox="icheckbox_square-blue" name="company[]" value="<?= $cat->supplier_id; ?>" ><?= $cat->company_name; ?>
                                     </label> 
                                <?php } ?>
                              </div>
                                   </div>
                          ...
                          <br>
                           <div class="col-sm-12">
                                <input type="submit" class="btn btn-success" value="Request Quote">
                           </div>
                      </form>
                </div>
              </div>
