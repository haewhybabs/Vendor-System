            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header">
                  <h3><i class="fa fa-table"></i> <strong>Sent Proposals</strong></h3>
                </div>
                      ...
                      <tbody>
                        ...
                        foreach($req_list as $vendor){
                          $date = strtotime($vendor->date_added);
                            if($vendor->rfx_status == 0){
                            $status='<span class="text-danger">Not sent</span>';  
                          }
                         if($vendor->rfx_status == 1){
                        ...
                        <tr>
                          ...
                          <td><?= $vendor->category; ?></td>
                           ...
                           <td>
                            <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-basic2<?= $vendor->id; ?>"><span class="fa fa-eye"></span> View Vendors</a>
                             <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-basic<?= $vendor->id; ?>"><span class="fa fa-eye"></span> View Proposal</a>
                           ...
                           <div class="col-sm-1">S/N</div>
                              <div class="col-sm-5">Name</div>
                               <div class="col-sm-3">Date Posted</div>  
                                <div class="col-sm-3">Expired Date</div>
                       </div>
