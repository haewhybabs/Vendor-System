     <link href="<?= base_url(); ?>assets/global/plugins/summernote/summernote.min.css" rel="stylesheet">    
            ...
            <div class="col-xlg-12 col-small-stats">
              <div class="row">
                ...
                <div class="panel-header bg-dark">
                  <h6 class="panel-title" style="font-size: 17px;">ADMINISTRATOR PO QUERY</h6>
                   </div>
        ...
        ?>
                ...
                <?php
                    ...
                    <form data-style="arrow" role="form" enctype="multipart/form-data" method="post" action="<?= site_url('budget_control/query_action') ?>">
