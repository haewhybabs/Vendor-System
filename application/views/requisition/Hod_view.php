<link href="<?= base_url(); ?>assets/global/plugins/datatables/dataTables.min.css" rel="stylesheet">
        ...
        ?>
                                      ...
                                      <form role="form" enctype="multipart/form-data" method="post" action="<?= site_url('Requisition/Hod_edit') ?>">
                                        <input type="hidden" name="req_detail_ID" value="<?=$detail->req_detail_ID;?>">
                                            ...
                                            <div class="col-sm-12 form-group ">
                                              ...
                                              <input type="text" class="form-control" name="product_specification" value="<?=$detail->product_specification;?>">
                                            </div>
          ...
          <br>
               ...
               <div class="col-sm-12">
                <?php if ($detail->req_status_ID==1):?>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#mModal3">Recommend</button>
                      <div id="mModal3" class="modal fade" role="dialog">
                            <div class="modal-dialog">
                 ...
                 <?php // To Reject the Specification ?>
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#mModal5">Not Recommended</button>
                      <div id="mModal5" class="modal fade" role="dialog">
                            <div class="modal-dialog">
