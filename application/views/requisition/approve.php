            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header">
                  <h3><i class="fa fa-table"></i> <strong>RECOMMENDED REQUISITIONS</strong></h3>
                </div>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?= $vendor->category; ?></td>
                           ...
                           <td>
                            <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-basic<?= $vendor->id; ?>"><span class="fa fa-eye"></span> View Recommended Requisitions</a>
                           </td>
