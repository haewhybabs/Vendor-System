        ...
        ?>
            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                ...
                <?php foreach ($detail_single as $d):?>
                <?php endforeach;?>

                    <!--  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal2">Activity History</button> -->
                     <a href="<?=base_url();?>Requisition/View_history/<?=$d->req_ID;?>" class="btn btn-success btn-sm">Download History</a>
          ...
          <br>
               ...
               <div class="col-sm-12">
                <?php if ($detail->req_status_ID==4):?>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal1">Recommend</button>
                 ...
                 <?php // To Reject the Specification ?>
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal4">Not Recommended</button>
