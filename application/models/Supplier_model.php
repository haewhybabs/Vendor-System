...
class Supplier_model extends CI_Model
{
    ...
    public function update_vendor_contact($data,$ved){
        $update=array(
      ...
      $this->db->set($update);
      $this->db->where('supplier_id',$ved);
      $this->db->update('e_vendor');
    }
     public function get_previous($id){
        return $this->db->where('supplier_id',$id)->get('e_vendor')->result();
    }
    ...
    public function get_interview_details(){
       return $this->db->get('vendor_interview')->result();
    }
}