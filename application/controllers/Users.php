...
class Users extends MY_Controller {
    ...
    public function update_user($id){
      ...
      $data=array(
          'user'=>$this->Login_model->get_each_user($id),
          'title'=>'Update Users',
          'department'=>$this->Login_model->get_all_department(),

      );
      $this->template->load('template','users/update_user',$data);
    ...
    public function update_user_action(){
      ...
      $this->Login_model->update_new_user($data,$user_id);
